...
const prompt = `Ты — ассистент, который анализирует ФОТО школьного задания (1–4 класс) по математике или русскому языку. Работай аккуратно и не додумывай факты.
Задача:
